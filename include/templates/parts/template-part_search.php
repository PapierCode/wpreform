...
function pc_display_form_search() {
		...
		echo '<form id="form-search" class="form-search mw" method="get" action="'.get_bloginfo('url').'">';
			...
			echo '<button type="submit" class="form-search-submit reset-btn button" title="Rechercher"><span class="ico">'.pc_svg('zoom').'</span><span class="visually-hidden">Rechercher</span>'.'</button>';
		echo '</form>';
